...
VALUES (uuid_generate_v4(), 0.5, '12:00:00', '20:00:00'),
       (uuid_generate_v4(), 0.3, '06:00:00', '13:00:00'),
       (uuid_generate_v4(), 1, '07:00:00', '15:00:00'),
       (uuid_generate_v4(), 0.4, '06:00:00', '21:00:00'),
       (uuid_generate_v4(), 0.6, '06:00:00', '22:00:00'),
       (uuid_generate_v4(), 0.4, '06:00:00', '23:00:00'),
       (uuid_generate_v4(), 0.9, '06:00:00', '23:00:00'),
       (uuid_generate_v4(), 0.8, '10:00:00', '22:00:00')
;